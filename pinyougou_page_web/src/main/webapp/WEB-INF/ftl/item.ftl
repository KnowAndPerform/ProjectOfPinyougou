...
<head>
    ...
    <script type="text/javascript">
        //定义js变量:接收当前html的spec
        var spec = ${item.spec};
        //组装集合:[{"id":  , "spec":  }]对象;封装页面的id  和  spec
        var specList = [
...
<div class="py-container">
    ...
    <#--[{"color":"蓝色","url":"http://192.168.25.133/group1/M00/00/00/wKgZhVyR-rqAVKf4AAA0JGtMezo823.jpg"},
            {"color":"黑色","url":"http://192.168.25.133/group1/M00/00/00/wKgZhVyR-sSAPxcwAACkjQ1wmnU915.jpg"},
            {"color":"灰色","url":"http://192.168.25.133/group1/M00/00/00/wKgZhVyR-s2AMflrAAEHFyM11jc267.jpg"}]-->
            ...
            <div class="fl preview-wrap">
                ...
                <div class="zoom">
                    ...
                    <div id="preview" class="spec-preview">
                        <span class="jqzoom"><img jqimg="imageList[0]" src="imageList[0]"/></span>
                    </div>
                    <!--下方的缩略图,imageList>0才有循环...-->
                    ...
                    <div id="specification" class="summary-wrap clearfix">
                         <#list specList as spec>
                             <dl>
                                ...
                                <#--判断所有的规格中,哪组spec与当前html页spec相同,相同的组被勾选-->
                                <dd><a href="javascript:;" class="{{isSeclect('${spec.attributeName}','${value}')?'selected':''}}" ng-click="updateSpecOption('${spec.attributeName}','${value}')">${value}<span title="点击取消选择">&nbsp;</span>
                                </#list>
                             </a></dd>
                             </dl>
                         </#list>
                    ...
                    <div class="summary-wrap">
                        ...
                        <div class="fl">
                            <ul class="btn-choose unstyled">
                                <li>
                                    <a ng-click="addItemToCartList()" href="cart.html" target="_blank" class="sui-btn  btn-danger addshopcar">加入购物车</a>
                                </li>
                            </ul>
                        </div>
                    </div>
